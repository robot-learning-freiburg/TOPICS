#!/usr/bin/env bash
task="configs/city/task_files/l2_increment_6tasks"
method="FT"
...
weights="--step_prev_ckpt output/city_l2_increment_6tasks-ov/eucl_rn_v4.0_ft_sq_v2_60ep/step0/model_final.pth"
...
weights="--step_prev_ckpt output/city_l2_increment_6tasks-ov/eucl_rn_v4.0_ft_lr2_60ep/step0/model_final.pth"
for t in 1 2 3 4 5; do
