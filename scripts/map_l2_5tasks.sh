#!/usr/bin/env bash
task="configs/map/task_files/l2_increment_5tasks"
method="FT"
...
weights="--step_prev_ckpt output/map_l2_increment_6tasks-ov/eucl_rn_v4.0_ft_sq_v2_60ep/step0/model_final.pth"
for t in 1 2 3 4; do
...
weights="--step_prev_ckpt output/map_l2_increment_6tasks-ov/eucl_rn_v4.0_ft_lr2_60ep/step0/model_final.pth"
for t in 1 2 3 4; do
