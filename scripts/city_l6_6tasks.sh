task="configs/city/task_files/l6_increment_6tasks"
method="TOPICS"
...
weights="--step_prev_ckpt output/city_l6_increment_6tasks-ov/hyp_rn_v4.0_hiera_mh3_ep60_c2/step0/model_final.pth"
