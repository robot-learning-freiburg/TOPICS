#!/usr/bin/env bash
task="configs/map/task_files/l24_increment_2tasks"
method="FT"
...
weights="--step_prev_ckpt output/map_l24_increment_2tasks-ov/eucl_rn_v4.0_ft_sq_v2_60ep/step0/model_final.pth"
for t in 1; do
...
weights="--step_prev_ckpt output/map_l24_increment_2tasks-ov/eucl_rn_v4.0_ft_lr2_60ep/step0/model_final.pth"
for t in 1; do
...
run_setting="--sample_num 2 --dataset map --batch_size 32 --autocast"
method="DKD"
name="dkd-v4-60ep-t5"
...
run_setting="--sample_num 2 --dataset map --batch_size 24 --autocast --unseen_cluster 1"
method="MICROSEG"
