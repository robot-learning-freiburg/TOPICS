task="configs/map/task_files/l26_increment_5tasks"
method="TOPICS"
...
weights="--step_prev_ckpt output/map_l26_increment_5tasks-ov/hyp_rn_v4.0_hiera_mh3_ep60_c2/step0/model_final.pth"
for t in 1 2 3 4; do
