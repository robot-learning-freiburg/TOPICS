#!/usr/bin/env bash
task="configs/map/task_files/l2_increment_3tasks"
method="FT"
...
weights="--step_prev_ckpt output/map_l2_increment_3tasks-ov/eucl_rn_v4.0_ft_sq_v2_60ep/step0/model_final.pth"
for t in 1 2; do
...
weights="--step_prev_ckpt output/map_l2_increment_3tasks-ov/eucl_rn_v4.0_ft_lr2_60ep/step0/model_final.pth"
for t in 1 2; do
