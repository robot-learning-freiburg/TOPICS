...
task="configs/synmedi/task_files/l26_increment_7tasks"
method="TOPICS+"
...
for t in 1 2 3 4 5 6; do
  incr_setting="--step ${t} --epoch 30 --lr 0.02 --distance_sim_weight 10 --triplet_loss_weight 0.01 --num_workers 12"
