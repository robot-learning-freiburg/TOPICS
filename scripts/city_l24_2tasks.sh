#!/usr/bin/env bash
task="configs/city/task_files/l24_increment_2tasks"
method="FT"
...
weights="--step_prev_ckpt output/city_l24_increment_2tasks-ov/eucl_rn_v4.0_ft_sq_v2_60ep/step0/model_final.pth"
for t in 1; do
...
weights="--step_prev_ckpt output/city_l24_increment_2tasks-ov/eucl_rn_v4.0_ft_lr2_60ep/step0/model_final.pth"
for t in 1; do
