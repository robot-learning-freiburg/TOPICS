...
from .residual import ResidualBlock, GlobalAvgPool2d
...
class ResNet(nn.Module):
    ...
    Retrieved from: https://github.com/fcdl94/MiB and https://github.com/arthurdouillard/CVPR2021_PLOP
    """
    ...
    def __init__(
        ...
        self.plop = plop
        if plop:
            print("PLOP activated in backbone!")
